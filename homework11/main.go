...
func main() {
	...
	s = "a bb aa ccc aaa b a c cc"
	fmt.Println("Sort: ", s)
	fmt.Println("Result: ", SortByLength(s))

	fmt.Println(findAnagram("my name is mane", "ym mane enma si"))

	fmt.Println(GenerateSubstrings("abc"))

	s = "Hello Robot"
	fmt.Println("Task 23")
	fmt.Println(s)
	fmt.Println(returnSHA256(s))
